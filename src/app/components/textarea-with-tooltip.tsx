...
interface TextareaWithTooltipProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  tooltip?: string
  description?: string
}

export const TextareaWithTooltip = ({ tooltip, description, className, ...props }: TextareaWithTooltipProps) => {
  ...
  return (
    <div className="relative">
      <textarea
        {...props}
        className={cn(
          "w-full text-base/6 rounded-md bg-black/50 hover:bg-black/75 focus-visible:outline-none ring-2 ring-transparent hover:ring-zinc-800 focus:ring-zinc-800 focus:bg-black/75 transition h-24 px-4 py-2 text-zinc-100 resize-none",
